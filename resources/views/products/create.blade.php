                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_stock_level') is-invalid @enderror" 
                                           id="max_stock_level" name="max_stock_level" value="{{ old('max_stock_level', 1000) }}" 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" id="profitMargin" placeholder="0" step="0.01">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0 mt-2">
                            <li>Min Level: Alerts when stock reaches this level</li>
                            <li>Max Level: Maximum stock to maintain</li>
                            <li>Current: Starting stock quantity</li>
                        </ul>
                    </div>
                </div>
            </div>
